...
class ProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate {
    ...
    var str_actualoccupationtext:String = ""
   ...
   var fruitsArray:[String] = Array()
    ...
    @IBOutlet var buildnolabel: UILabel!
    
    @IBOutlet var buildiongnotxtfd: UITextField!
...
//        self.defaults.set(self.str_occupation, forKey: "str_occupationnew")
       ...
       // occcunewtextinte
        ...
        self.defaults.set(self.str_occupationtext, forKey: "str_occupationnewtext")
          ...
          //new
          // occcunewtextinte
          str_actualoccupationtext = self.actualoccutxtfd.text!
           self.defaults.set(self.str_actualoccupationtext, forKey: "str_actualoccupationtext")
...
//            self.navigationItem.backBarButtonItem = UIBarButtonItem(title: "", style: .plain, target: nil, action: nil)
//            let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
//            let nextViewController = storyBoard.instantiateViewController(withIdentifier: "ProfilePhoto3ViewController") as! ProfilePhoto3ViewController
//            self.navigationController?.pushViewController(nextViewController, animated: true)
...
//            }()
    ...
    override func viewDidLoad() {
        ...
        self.municipalitySearchView.placeholder = "Search"
        
        self.updateBtn.setTitle(NSLocalizedString("update", comment: ""), for: .normal)
        
        idfrontbtn.layer.cornerRadius = 15
        idbackbtn.layer.cornerRadius = 15
        selfibtn.layer.cornerRadius = 15
        
        //new
        idselfielabel.isHidden = true
        selfibtn.isHidden = true
       ...
       // view2.isHidden = true
        ...
        let custmEditProfileBtn = UIBarButtonItem(image: UIImage(named: "editImg.png"), style: .done, target: self, action: #selector(editProfile))
        ...
        self.addressTextField.layer.borderWidth = 0.8
        self.addressTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
        ...
        self.expectedIncomeTextField.layer.borderWidth = 0.8
        self.expectedIncomeTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
        self.workingAddrTextField.layer.borderWidth = 0.8
        self.workingAddrTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
        ...
        self.actualoccutxtfd.layer.borderWidth = 0.8
        self.actualoccutxtfd.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
        ...
        self.idExpTextField.layer.borderWidth = 0.8
        self.idExpTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
        
        self.buildiongnotxtfd.layer.borderWidth = 0.8
        self.buildiongnotxtfd.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor

        
        //new
        self.fullnameEnTextField.delegate = self
        self.fullnameArTextField.delegate = self
        self.dobTextField.delegate = self
        self.addressTextField.delegate = self
        self.buildiongnotxtfd.delegate = self
        self.employerTextField.delegate = self
        self.expectedIncomeTextField.delegate = self
        self.workingAddrTextField.delegate = self
        self.idExpTextField.delegate = self
        ...
        //new
        fullnameEnTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        fullnameArTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        dobTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        addressTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        buildiongnotxtfd.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        mobileTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)

        employerTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        expectedIncomeTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        
        workingAddrTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)
        
        idExpTextField.addTarget(self, action: #selector(ProfileViewController.textFieldDidChange(_:)), for: .editingChanged)

        
//        //new logout
//                timer = Timer.scheduledTimer(timeInterval: 1*60, target: self, selector: #selector(ProfileViewController.doStuff), userInfo: nil, repeats: true)
...
//            self.fullnameEnTextField.text! = self.str_name_en
          ...
          //
           ...
           //
            ...
            //
            if ((self.defaults.string(forKey: "dualnationalityselstr")?.isEmpty) != nil)
            {
                
                self.dualnationalityselstr = defaults.string(forKey: "dualnationalityselstr")!
                self.dualnationalitybtn.setTitle(dualnationalityselstr, for: .normal)
                
            }
            else
            {
                
                self.dualnationalityselstr = ""
                self.dualnationalitybtn.setTitle(dualnationalityselstr, for: .normal)
            }
           ...
           // self.defaults.set(self.str_nationality, forKey: "str_nationalitynew")
            ...
            //
            if ((self.defaults.string(forKey: "str_buildingnotxtfd")?.isEmpty) != nil)
            {
                self.str_buildingnotxtfd = defaults.string(forKey: "str_buildingnotxtfd")!
               // self.addressTextField.text! = self.str_address
                self.buildiongnotxtfd.text! = str_buildingnotxtfd
            }
            else
            {
                self.str_buildingnotxtfd = ""
                self.buildiongnotxtfd.text! = self.str_buildingnotxtfd
            ...
            //
            if ((self.defaults.string(forKey: "str_actualoccupationtext")?.isEmpty) != nil)
            {
                //ivde occupation
               
            self.str_actualoccupationtext = defaults.string(forKey: "str_actualoccupationtext")!
            self.actualoccutxtfd.text! = self.str_actualoccupationtext
            ...
            //new occupation id actual
            
            if ((self.defaults.string(forKey: "str_occupationnew")?.isEmpty) != nil)
            {
                self.str_occupation = defaults.string( forKey: "str_occupationnew")!
            }
            ...
            idselfielabel.isHidden = false
            selfibtn.isHidden = false
        ...
        if let savedValue = userdefaultselfielabelphotostr.string(forKey: "selfielabelphotostr"){
           ...
           // idselfielabel.font = idselfielabel.font.withSize(13)
                ...
                //idselfielabel.text = "  selfie with ID"
    ...
    @objc func textFieldDidChange(_ textField: UITextField) {
        if(textField == nationalitySearchTextField)
        {
            ...
            {
            if(self.nationalitySearchTextField.text?.count != 0)
            {
...
//        self.emailTextField.isUserInteractionEnabled = true
        ...
        self.dualnationalitybtn.isUserInteractionEnabled = true
...
//        self.mobileTextField.isUserInteractionEnabled = true
        ...
        self.buildiongnotxtfd.isUserInteractionEnabled = true
...
//        self.idNumTextField.isUserInteractionEnabled = true
    ...
    func disableFields() {
        ...
        self.dualnationalitybtn.isUserInteractionEnabled = false
        ...
        self.buildiongnotxtfd.isUserInteractionEnabled = false
...
//
        ...
        var string2homeAddr = addressTextField.text!
...
//                     print("check name",self.addressTextField.text)
        ...
        if buildiongnotxtfd.text?.isEmpty == true
        {
            ...
            self.buildiongnotxtfd.layer.borderColor = UIColor.red.cgColor
            Timer.scheduledTimer(withTimeInterval: 5.0, repeats: false) { (Timer) in
                self.buildiongnotxtfd.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
            }
        ...
        var string2buildno = buildiongnotxtfd.text!
...
//        }
        ...
        guard let emp = employerTextField.text,employerTextField.text?.count != 0 else
        {
            ...
            self.view2.isHidden = true
            //self.scrollView.setContentOffset(.zero, animated: true)
            let bottomOffset = CGPoint(x: 0, y: 380)
            //OR
            //let bottomOffset = CGPoint(x: 0, y: scrollView.frame.maxY)
            scrollView.setContentOffset(bottomOffset, animated: true)
...
//                   print("check name",self.employerTextField.text)
        ...
        //new
        if expectedIncomeTextField.text?.isEmpty == true
        {
           // timer.invalidate()
            self.expectedIncomeTextField.layer.borderColor = UIColor.red.cgColor
            Timer.scheduledTimer(withTimeInterval: 5.0, repeats: false) { (Timer) in
                self.expectedIncomeTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
            }
        }
...
//                self.present(alert, animated: true, completion: nil)
        ...
        //new
        if workingAddrTextField.text?.isEmpty == true
        {
           // timer.invalidate()
            self.workingAddrTextField.layer.borderColor = UIColor.red.cgColor
            Timer.scheduledTimer(withTimeInterval: 5.0, repeats: false) { (Timer) in
                self.workingAddrTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
            }
        }
...
//                 print("check name",self.workingAddrTextField.text)
        ...
        //new
        if actualoccutxtfd.text?.isEmpty == true
        {
           // timer.invalidate()
            self.actualoccutxtfd.layer.borderColor = UIColor.red.cgColor
            Timer.scheduledTimer(withTimeInterval: 5.0, repeats: false) { (Timer) in
                self.occupationTextField.layer.borderColor = UIColor(red: 0.70, green: 0.69, blue: 0.67, alpha: 1.00).cgColor
            }
        }
...
//        self.defaults.set(self.str_occupation, forKey: "str_occupationnew")
    ...
    func setFont() {
        ...
        dualnationalitylbl.font = UIFont(name: "OpenSans-Regular", size: 14)
        ...
        zoneBtn.titleLabel?.font = UIFont(name: "OpenSans-Regular", size: 16)
        ...
        actualoccutxtfd.font = UIFont(name: "OpenSans-Regular", size: 14)
        buildiongnotxtfd.font = UIFont(name: "OpenSans-Regular", size: 14)
        buildnolabel.font = UIFont(name: "OpenSans-Regular", size: 14)
    ...
    func setFontSize() {
        ...
        dualnationalitylbl.font = dualnationalitylbl.font.withSize(14)
        ...
        //buildiongnotxtfd.font = buildiongnotxtfd.font.withSize(14)
        buildnolabel.font = buildnolabel.font.withSize(14)
        ...
        dualnationalitybtn.titleLabel?.font = dualnationalitybtn.titleLabel?.font.withSize(14)
    ...
    func getProfileInfo(access_token:String) {
        ...
        ProfileViewController.AlamoFireManager.request(url, method: .post, parameters: params, encoding: JSONEncoding.default, headers: headers).responseJSON(completionHandler: { (response) in
            ...
            if(respCode == "S104")
            {
               ...
               // self.emailTextField.text = myResult!["email"].stringValue
                ...
                {
                self.addressTextField.text = myResult!["street"].stringValue
        ...
        if(myResult!["mZone"].stringValue == "-") || (myResult!["mZone"].stringValue == "Zone")
                ...
                self.self.dualnationalityselstr = myResult!["customerCountry"].stringValue
    ...
    func updateProfile(access_token:String) {
        self.activityIndicator(NSLocalizedString("loading", comment: ""))
        let dateTime:String = getCurrentDateTime()
        let url = ge_api_url + "customer/updatecustomer"
        print("1",str_id_no)
...
//        }
    ...
    testlastnamestr = result[2] as! String + " " + result[3] as! String + " " + result[4] as! String
       ...
       //testfirstnamestr
        ...
        let params:Parameters =  ["partnerId":partnerId,"token":token,"requestTime":dateTime,"customerIDNo":str_id_no,"customerRegNo":defaults.string(forKey: "REGNO")!,"customerFullName":str_name_en,"customerFirstName":testfirstnamestr,"customerMiddleName":testmiddlenamestr,"customerLastName":testlastnamestr,"customerFullNameArabic":str_name_ar,"customerAddress":str_address,"customerCity":str_city,"customerMobile":strMobile,"customerPhone":appVersion,"customerZipCode":"IOS","customerCountry":self.dualnationalityselstr,"customerDOB":self.str_dob,"customerCountryOfBirth":"VIDEOS","customerBirthPlace":str_nationality,"gender":str_gender,"customerNationality":str_nationality,"occupation":str_occupation,"email":strEmail,"customerIDType":"QID","customerIDIssuedDate":str_id_exp_date,"customerIDExpiryDate":self.str_id_exp_date,"customerIDIssuedBy":str_id_issuer,"customerIDIssuedCountry":"QAT","visaNo":"","visaIssuedBy":"","visaIssuedDate":"","visaExpiryDate":"","visaType":"","password":defaults.string(forKey: "PASSW")!,"mpin":defaults.string(forKey: "PIN")!,"idImageFront":strBase64,"idImageBack":strBase641,"idImageSelfie":strBase64videoProfile,"idDocAdditional1":"","idDocAdditional2":"","employerName":str_employer,"workingAddress1":str_working_address,"workingAddress2":str_actualoccupation,"workingAddress3":"","expectedIncome":str_income,"mZone":str_zone,"securityQuestion3":str_buildingnotxtfd]
...
//                cell.label.text = zone.zone
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            if  dualnationalityselstr == "0"
             {
                ...
                if(checkCountry == 0)
                {
                    ...
                    print("str_countryselclicked",str_country)
            ...
            else
            {
                ...
                if(checkCountry == 0)
                {
                    ...
                    if natselserchstr == "searchcliked"
                    {
                        ...
                        UserDefaults.standard.removeObject(forKey: "dualnationalityselstr")
                       ...
                       // let firstName = AllArrayid[indexone]
                        let firstName = checkarrayaoccunatstr[indexone]
                        print("id selkityada:\(firstName)")
                        dualnationalityselstr = firstName
                        //print("id selkityadastr_natid:\(str_country_2_code)")
                        
                        
                        
                        self.dualnationalitybtn.setTitle("\(teststrclsnat)", for: .normal)
                        self.dualnationalitybtn.setTitleColor(UIColor.black, for: .normal)
                    ...
                    {
                        UserDefaults.standard.removeObject(forKey: "dualnationalityselstr")
                        self.dualnationalityselstr = nat.alpha_3_code
        ...
        dualnationalitybtn.titleLabel?.font = dualnationalitybtn.titleLabel?.font.withSize(14)
                    ...
                    print("dualnationalityselstrfinaly",dualnationalityselstr)
                    ...
                    let str: String = cell.countryLbl.text!
                    let country = countryResArray[indexPath.row]
                    self.dualnationalityselstr = country.alpha_3_code
                    print("dualnationalityselstrclicked",dualnationalityselstr)
                   // countryResiBtn.setTitle("\(str)", for: .normal)
                    nationalityView.isHidden = true
                    view1.isHidden = false
                }
                 ...
                 if occupationselsearchstr == "searchcliked"
                 {
                    ...
                    // let firstName = AllArrayid[indexone]
                     ...
                     UserDefaults.standard.removeObject(forKey: "str_occupationnew")
                                 self.str_occupation = firstName
                     
                     self.defaults.set(self.str_occupation, forKey: "str_occupationnew")
                                // self.zoneBtn.setTitle("Zone", for: .normal)
                                // self.zoneArray.removeAll()
                                // self.tblzone.reloadData()
                                 print("occupation iddddserched",firstName)
                                 backbtnteststr = "0"
                     municipalityView.isHidden = true
                     view1.isHidden = false
           ...
           if  actualoccupationselstr == "actualoccupationselstr"
           {
               if occupationselsearchstr == "searchcliked"
                  ...
                  // let firstName = AllArrayid[indexone]
                   ...
                   print("id selkityadastr_occupation:\(str_actualoccupation)")
                   

                   UserDefaults.standard.removeObject(forKey: "str_actualoccupation")
                   self.str_actualoccupation = firstName
                   self.defaults.set(self.str_actualoccupation, forKey: "str_actualoccupation")

                   // self.zoneBtn.setTitle("Zone", for: .normal)
                              // self.zoneArray.removeAll()
                              // self.tblzone.reloadData()
                               print("actualoccupation search iddddserched",firstName)
                               backbtnteststr = "0"
                   municipalityView.isHidden = true
                   view1.isHidden = false
        ...
        else if(tableView == tblzone)
        {
            ...
            if zoneselserchstr == "searchcliked"
            {
                ...
                teststrclszone = searchedArrayzone[indexPath.row]
                                print("selectednamesearch",teststrclszone)
...
extension String {
    ...
    func removeExtraSpacesprofile() -> String {
...
extension String {
    ...
    func removeExtraSpacesprofilenospace() -> String {
        return self.replacingOccurrences(of: "[\\s\n]+", with: "", options: .regularExpression, range: nil)
    }
