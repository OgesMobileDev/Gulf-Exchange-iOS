//
//  ProfilePhoto2ViewController.swift
//  GulfExchangeApp
//
...
class ProfilePhoto2ViewController: UIViewController,AVCapturePhotoCaptureDelegate {
...
//            let imageData = capturedImageView.image!.pngData() as NSData?
            ...
            self.defaults.set(strBase641, forKey: "strBase641photo1")
            
            backlabelphotostr = "  Back ID Selected"
            self.defaults.set(backlabelphotostr, forKey: "backlabelphotostr")
...
//            let alertController = UIAlertController(title: "Back ID selected", message: "", preferredStyle: .alert)
//
//              // Create the actions
