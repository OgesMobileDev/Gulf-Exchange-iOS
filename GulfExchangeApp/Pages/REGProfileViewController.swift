//
//  REGProfileViewController.swift
//  GulfExchangeApp
//
//  Created by test on 06/12/21.
...
class REGProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate {
...
//            }()
    ...
    @objc private dynamic func didRecognizeTapGesture(_ gesture: UITapGestureRecognizer) {
       ...
       //do
        ...
        self.municipalitySearchView.isHidden = true
...
//        }
        ...
        let processedString = startingString.removeExtraSpacesprofilereg()
...
//
        ...
        let processedStringhomeaddress = startingStringhomeadress.removeExtraSpacesprofilereg()
...
//        }
        ...
        let processedStringemployer = startingStringemployer.removeExtraSpacesprofilereg()
...
//                   print("check name",self.employerTextField.text)
        ...
        let processedStringexpincome = startingStringexpincome.removeExtraSpacesprofilenospacereg()
...
//                self.present(alert, animated: true, completion: nil)
        ...
        let processedStringworkaddress = startingStringworkaddress.removeExtraSpacesprofilereg()
...
//        }
        ...
        let processedStringnamear = startingStringnamear.removeExtraSpacesprofilereg()
...
extension String {
    ...
    func removeExtraSpacesprofilereg() -> String {
...
extension String {
    ...
    func removeExtraSpacesprofilenospacereg() -> String {
        return self.replacingOccurrences(of: "[\\s\n]+", with: "", options: .regularExpression, range: nil)
    }
