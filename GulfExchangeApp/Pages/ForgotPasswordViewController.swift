...
class ForgotPasswordViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet var mobcodetxtfiled: UITextField!
...
//        }
        ...
        if #available(iOS 13.0, *) {
           // overrideUserInterfaceStyle = .light
            ...
            if( self.traitCollection.userInterfaceStyle == .dark ){
                ...
                self.mobcodetxtfiled.layer.borderColor = UIColor.lightGray.cgColor
                self.mobcodetxtfiled.layer.borderWidth = 0.8
        ...
        let appleLanguages = UserDefaults.standard.object(forKey: "AppleLanguages") as! [String]
                                          ...
                                          if appLang == "ar" || appLang == "ur" {
                                            ...
                                            mobcodetxtfiled.textAlignment = .center
                                          } else {
        ...
        self.title = NSLocalizedString("forgot_password", comment: "")
...
//        }
    ...
    @IBAction func resendBtn(_ sender: Any) {
        getOTP(msg: NSLocalizedString("otp_resent", comment: ""))
    }
    ...
    func setFont() {
        ...
        resendBtn.titleLabel?.font = UIFont(name: "OpenSans-Bold", size: 14)
    }
    func setFontSize() {
    ...
    func getToken() {
        ...
        ForgotPasswordViewController.AlamoFireManager.request(url, method: .post, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON(completionHandler: { (response) in
            ...
            case .success:
                ...
                print("token4  ",token)
                self.validateEmailMobile(accessToken: token, email: self.strEmail)
                break
            case .failure:
                break
            }
    ...
    func validateEmailMobile(accessToken:String,email:String) {
        self.activityIndicator(NSLocalizedString("loading", comment: ""))
        ...
        ForgotPasswordViewController.AlamoFireManager.request(url, method: .post, parameters: params, encoding: JSONEncoding.default, headers: headers).responseJSON(completionHandler: { (response) in
            ...
            if(respCode == "S9004")
            {
                ...
                if let range = resMsg.range(of: "@") {
                   ...
                   // self.strMobile = mobile
                    ...
                    self.getOTP(msg: NSLocalizedString("we_have_send_otp_to_email_mob", comment: ""))
                }
            }
            else{
        ...
        let params:Parameters = ["id_no":self.strUserId,"email":self.strEmail,"type":"2","mobile_no":self.strMobile]
          ...
          AF.request(url, method: .post, parameters: params, encoding: JSONEncoding.default, headers: nil).responseJSON(completionHandler: { (response) in
            ...
            case .success:
                ...
                if(respCode == "1")
                {
                    self.mobcodetxtfiled.isHidden  = true
          ...
          AF.request(url, method: .post, parameters: params, encoding: JSONEncoding.default, headers: nil).responseJSON(completionHandler: { (response) in
            ...
            case .success:
                ...
                if(respCode == "1")
                {
                   ...
                   let nextViewController = storyBoard.instantiateViewController(withIdentifier: "resetPassw") as! ResetPasswordViewController
