...
class HelpCenterVC: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func emailBtnTapped(_ sender: Any) {
        ...
        if self.defaults.bool(forKey: "accessibilityenabled"){
            SpeechHelper.shared.speak("email us", languageCode: "en")
        }
        
        sendEmail()
    }
    @IBAction func callUsBtnTapped(_ sender: Any) {
        
        if self.defaults.bool(forKey: "accessibilityenabled"){
            SpeechHelper.shared.speak("call us", languageCode: "en")
        }
